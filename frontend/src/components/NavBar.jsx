...
function NavBar() {
  ...
  return (
    <nav className="flex md:h-full md:w-fit max-md:h-fit max-md:w-full flex-col max-md:flex-row justify-between items-center md:p-3 md:py-16 max-md:p-3 sm:px-[10%] bg-[#6e00ff] rounded-2xl">
      <div className=" md:h-1/2 max-md:min-w-1/2 flex md:flex-col justify-between md:gap-4 max-md:gap-10 max-sm:gap-3">
        ...
        <ul className="flex gap-5 md:flex-col items-center">
          <li>
            <span class="material-symbols-outlined sm:text-3xl text-white">
              group
            </span>
          </li>
          <li>
          ...
          <li>
            <span class="material-symbols-outlined sm:text-4xl text-white">
              settings
            </span>
          </li>
        </ul>
